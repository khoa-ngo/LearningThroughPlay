...
const int16_t GEAR_RATIO = 111;  // default 111
...
const int16_t MOTOR_SPEED_LIMIT = 300;  // default 300
...
const int16_t ANGLE_RATE_RATIO = 160;  //default 140
...
const int16_t ANGLE_RESPONSE = 11;  // default 11
...
const int16_t DISTANCE_RESPONSE = 73; //default 73
...
const int16_t DISTANCE_DIFF_RESPONSE = -50;  //default -50
